...
Public Class ViewLecturerTimetable
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        If cboWeekYear.Text = "" Or cboWeekYear.Text = "Week / Year" Or txtLecturerName.Text = "" Then
    ...
    Private Sub ViewLecturerTimetable_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=SDPassignment.accdb;Persist Security Info=False;")
        conn.Open() 'opens the connection
    ...
    Private Sub txtLecturerName_GotFocus(sender As Object, e As EventArgs) Handles txtLecturerName.GotFocus
        ToolTipBaloon.IsBalloon = True
        ToolTipBaloon.InitialDelay = 10
        ToolTipBaloon.SetToolTip(txtLecturerName, "Please Enter Lecturer Name Here !")
    End Sub
End Class